    ...
    <>
      <nav className={`${styles.paddingX} w-full flex items-center py-3 fixed top-0 z-20 bg-primary`}>
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
          ...
          >
            <img src={"https://i.pinimg.com/originals/7a/7b/eb/7a7beb6f0b118ca1a2bc76822212839e.png"} alt="logo" className="w-15 h-10 object-contain" />
            <p className="text-white text-[20px] font-bold cursor-pointer flex">
              Alex
              <span className="sm:block hidden">KintuLadwong</span>
            </p>
          </Link>
